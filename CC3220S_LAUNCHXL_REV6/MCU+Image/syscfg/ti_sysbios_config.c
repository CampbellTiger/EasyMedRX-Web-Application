...
#include <ti/dpl/PowerCC32XX_tirtos.c>
#include <ti/dpl/TimestampPCC32XX_tirtos.c>
...
#include <ti/sysbios/family/arm/cc32xx/Seconds.c>
#include <ti/sysbios/hal/time.c>
#include <ti/sysbios/family/arm/m3/ClockSupport.c>
